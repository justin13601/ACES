...
class TestQueryFunctions(unittest.TestCase):
    ...
    def test_summarize_temporal_window(self):
        ...
        test_1_predicates_df = pl.DataFrame(
            {
                'subject_id': [1, 1, 1],
        ...
        test_1_predicate_cols = [col for col in test_1_predicates_df.columns if col.startswith('is_')]
        ...
        cases = [
            ...
            },
            {
                ...
                "predicates_df": test_1_predicates_df,
                "predicate_cols": test_1_predicate_cols,
